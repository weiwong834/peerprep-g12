...
export default function AttemptHistoryPage() {
  ...
  return (
    <div className="grid grid-cols-3 gap-3 h-[calc(100dvh-4rem)] min-h-0">
      {/* Left: Question */}
      <div className="bg-white rounded-xl shadow-sm p-6 overflow-auto">
        ...
        <div className="space-y-1 text-sm text-slate-600 mb-4">
          ...
          <p>Language: <strong>{session.language}</strong></p>
          <p>Duration: <strong>{getDuration(session.start_timestamp, session.end_timestamp)}</strong></p>
          <p>Date: <strong>{new Date(session.start_timestamp).toLocaleDateString("en-SG", { day: "numeric", month: "short", year: "numeric" })}</strong></p>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 flex flex-col min-h-0">
        <h2 className="text-lg font-semibold mb-3">Final Code</h2>
